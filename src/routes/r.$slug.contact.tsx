        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="space-y-4">
            ...
            <Info icon={ShoppingBag} label="Fulfilment">
              {r.pickupEnabled && "Pickup"}
              {r.pickupEnabled && r.deliveryEnabled && " · "}
              {r.deliveryEnabled && "Delivery"}
            </Info>

            {theme.showDeliveryAreas &&
              branding.deliveryAreas &&
              branding.deliveryAreas.length > 0 && (
